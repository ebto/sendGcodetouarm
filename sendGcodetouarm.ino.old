/*
   ...
   move-to command to 4 predefined coordinate.

   Step 1: Compile this sketch to Esplora Keep it connect to PC but
   don't touch buttons yet. If you have TFT LCD it displays which
   button is pressed.
      ...
      */
      if (newState == PRESSED) {
        ...
        if (buttons[thisButton] == SWITCH_DOWN) {
          //Serial.print("Down\t");
          Keyboard.print("#25 G0 X150 Y0 Z75 F10000\n");
          ...
          //Serial.print("Left\t");
          Keyboard.print("#25 G0 X180 Y180 Z75 F10000\n");
          ...
          //Serial.print("Up\t");
          Keyboard.print("#25 G0 X250 Y0 Z150 F10000\n");
          ...
          //Serial.print("Right\t");
          Keyboard.print("#25 G0 X180 Y-180 Z75 F10000\n");
